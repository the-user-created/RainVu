...
class InsightsModel extends FlutterFlowModel<InsightsWidget> {
  ...
  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel1;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel2;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel3;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel4;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel5;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel6;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel7;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel8;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel9;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel10;

  // Model for mtd_breakdown component.
  late MtdBreakdownModel mtdBreakdownModel11;
  ...
  @override
  void dispose() {
    mtdBreakdownModel1.dispose();
    mtdBreakdownModel2.dispose();
    mtdBreakdownModel3.dispose();
    mtdBreakdownModel4.dispose();
    mtdBreakdownModel5.dispose();
    mtdBreakdownModel6.dispose();
    mtdBreakdownModel7.dispose();
    mtdBreakdownModel8.dispose();
    mtdBreakdownModel9.dispose();
    mtdBreakdownModel10.dispose();
    mtdBreakdownModel11.dispose();
    mtdBreakdownModel12.dispose();
  }
}
